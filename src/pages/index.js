    ...
    <main>
      ...
      <div className={styles.controls}>
        <button className="prev" onClick={() => { const slider = sliderRef.current; slider.prepend(slider.lastChild); }}>
          <svg z-index="999" viewBox="0 0 512 512" width="32" height="32" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
        ...
        <button onClick={handleSendNotification}>發送通知</button>
      </div>
    </main>
  );
};
